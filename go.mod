...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.34.6
...
require (
	...
	github.com/rancher/aks-operator v1.13.4
	...
	github.com/rancher/eks-operator v1.13.4
	github.com/rancher/fleet/pkg/apis v0.14.2
	github.com/rancher/gke-operator v1.13.4
	...
	github.com/rancher/shepherd v0.0.0-20260226203139-49d59c4f8f7b
	github.com/rancher/steve v0.7.39
	...
	k8s.io/kube-aggregator v0.34.6
...
require (
	...
	k8s.io/cluster-bootstrap v0.34.6 // indirect
