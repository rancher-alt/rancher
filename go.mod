...
replace (
	...
	helm.sh/helm/v3 => github.com/rancher/helm/v3 v3.17.4-rancher1
...
require (
	...
	github.com/rancher/shepherd v0.0.0-20260218212534-699bc0595b97
...
require (
	...
	k8s.io/pod-security-admission v0.32.11 // indirect
