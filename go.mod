...
replace (
	...
	k8s.io/cri-client => k8s.io/cri-client v0.33.10
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.33.10
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.33.10
	k8s.io/endpointslice => k8s.io/endpointslice v0.33.10
	k8s.io/externaljwt => k8s.io/externaljwt v0.33.10
	k8s.io/kms => k8s.io/kms v0.33.10
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.33.10
	...
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.33.10
...
require (
	...
	github.com/rancher/shepherd v0.0.0-20260226203150-140ae618cbaa
...
require (
	...
	k8s.io/cluster-bootstrap v0.33.10 // indirect
